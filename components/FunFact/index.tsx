    ...
    <>
      ...
      <section className="px-4 py-20 md:px-8 lg:py-22.5 2xl:px-0">
        <div className="relative z-1 mx-auto max-w-c-1390 rounded-lg  py-22.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark xl:py-27.5">
          ...
          <h1 className="mt-2 text-4xl font-semibold text-black dark:text-white">3PHOST is a partner for the long run — at all stages of <br /> growth</h1>
          ...
          <div className="flex items-start justify-between gap-x-4 flex-wrap mt-[3rem]">
            ...
            <div className="sm:max-w-[20rem] sm:min-w-[20rem] sm:h-[30rem] mb-4">
              ...
              <p className="mt-7 text-wrap text-xl border-l-2 border-[#175CFF] pl-[1rem]">"We have a high item per order ratio, The ability to have variable costs and competitive pricing for shipping is important to us. We have days with over 1,000 orders and it’s not problem for 3PHOST."</p>
            </div>
