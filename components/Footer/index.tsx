...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-[#0A083B]">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="flex justify-between items-center pt-20 border-b pb-10">
            ...
            <div>
              <button className="w-[12rem] h-[3.5rem] rounded-3xl text-white bg-[#2F6DFF] font-bold">Request A Quote</button>
            </div>
          </div>
          {/* <!-- Footer Top --> */}
          <div className="py-10 lg:py-10">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              <motion.div variants={{ hidden: { opacity: 0, y: -20, }, visible: { opacity: 1, y: 0, }, }} initial="hidden" whileInView="visible" transition={{ duration: 1, delay: 0.5 }} viewport={{ once: true }} className="animate_top w-1/2 lg:w-1/4">
                <a href="/" className="relative">
                  <Image width={70} height={80} src="/images/logo/logo.png" alt="Logo" className="ml-[-0.9rem]" />
                </a>
                <p className="text-2xl text-white font-semibold mt-10 mb-5">Picked, packed, and shipped.</p>

                <div className="flex items-center gap-x-5 mb-5">
                  <BiLogoInstagramAlt className="text-[#175CFF] text-2xl" />
                  <FaFacebookSquare className="text-[#175CFF] text-2xl" />
                  <FaTwitter className="text-[#175CFF] text-2xl" />
              ...
              <div className="flex w-full flex-col gap-5 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                <motion.div variants={{ hidden: { opacity: 0, y: -20, }, visible: { opacity: 1, y: 0, }, }} initial="hidden" whileInView="visible" transition={{ duration: 1, delay: 0.1 }} viewport={{ once: true }} className="animate_top">
                  <h4 className="mb-9 text-lg font-medium text-white">Company</h4>
                  <ul>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Blog</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">About</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Resources</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary" >Careers</a>
                    </li>

                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Events</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Press</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Product</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary" >Pricing</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Contact Us</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Help Center</a>
                    </li>
                  </ul>
                </motion.div>

                <motion.div variants={{ hidden: { opacity: 0, y: -20, }, visible: { opacity: 1, y: 0, }, }} initial="hidden" whileInView="visible" transition={{ duration: 1, delay: 0.1 }} viewport={{ once: true }} className="animate_top">
                  <h4 className="mb-9 text-lg font-medium text-white">Integrations & Partners</h4>
                  <ul>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Become a Partner</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">All Partners</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Shopify</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary" >TikTok Shop</a>
                    </li>

                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Affiliates</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">BigCommerce</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Marketplaces</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary" >NetSuite</a>
                    </li>
                    <li>
                ...
                <motion.div variants={{ hidden: { opacity: 0, y: -20, }, visible: { opacity: 1, y: 0, }, }} initial="hidden" whileInView="visible" transition={{ duration: 1, delay: 0.1 }} viewport={{ once: true }} className="animate_top">
                  <h4 className="mb-9 text-lg font-medium text-white">Legal</h4>
                  <ul>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Privacy Policy</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Terms & Conditions</a>
                    </li>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Supplier Code of Conduct </a>
                    </li>
                  </ul>
                </motion.div>

                <motion.div variants={{ hidden: { opacity: 0, y: -20, }, visible: { opacity: 1, y: 0, }, }} initial="hidden" whileInView="visible" transition={{ duration: 1, delay: 0.1 }} viewport={{ once: true }} className="animate_top">
                  <h4 className="mb-9 text-lg font-medium text-white">Resources</h4>
                  <ul>
                    <li>
                      <a href="#" className="mb-3 inline-block hover:text-primary">Product Releases</a>
                    </li>
                    <li>
