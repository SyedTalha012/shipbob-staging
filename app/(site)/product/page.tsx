...
const ProductPage = () => {
    return (
        <div>
            ...
            <Cards item={1} position={2} p1={"We’ve onboarded thousands of ecommerce merchants and helped some of the fastest-growing brands scale effortlessly. Our implementation team sets you up for success with everything from configuring your ship options, to syncing your online store."} p2={"3PHOST's turnkey integrations with all major ecommerce platforms and marketplaces – including Shopify, BigCommerce, Amazon, and Walmart – let you import orders and send data back and forth for a two-way flow of information."} heading={"Easy and helpful"} url={Image} brWord={"onboarding"} />

            <Cards item={2} position={1}
                p1={"With 3PHOST network of fulfillment centers, you can strategically split your inventory across our locations to get your products from point A to point B more quickly and affordably. Storing inventory near your customers helps reduce the shipping zones and costs associated with shipping orders to faraway destinations."}
                p2={"Distributed inventory also helps you stay competitive by offering two-day shipping to your customers. When an order is placed, 3PHOST algorithm automatically selects the warehouse and carrier that will give you the quickest turnaround at the best price. This strategy has helped our merchants bring 13% savings to their bottom line."}
                heading={"Distributed"}
                url={Distributed}
                brWord={"inventory"}
            />
            ...
            <Cards item={2} position={2}
                p1={"3PHOST 2-Day Express Shipping Program enables fast delivery for all continental US orders for any of our ecommerce store integrations. With 2-day shipping as the standard, merchants have been able to reduce cart abandonment by 18% and increase average order value by 97%. "}
            ...
            <Cards item={2} position={1}
                p1={"At 3PHOST, we track your orders from A to Z. Filter orders by status, search for specific orders, see a quick timeline view of where your order is in the fulfillment process (e.g. when an order is picked, packed, or shipped), easily find shipping-related information (e.g., weights, dimensions, or carrier service), and get a quick snapshot of any orders that require action."}
                p2={"With order management software for your direct-to-consumer and wholesale shipments, you can manage subscriptions, make changes to your orders post-purchase, map your store’s shipping options to 3PHOST, and automatically share tracking information with your customers."}
            ...
            <Cards item={2} position={1}
                p1={"To provide you with visibility into our operations and performance, and also hold ourselves accountable, 3PHOST free analytics tool is packed with charts to help you with everything from year-end reporting, to better supply chain decision-making."}
            ...
            <Cards item={2} position={2}
                p1={"From custom branded boxes to free plain packaging, 3PHOST works with you to provide the unboxing experience you want. We also help you offer the fastest, most cost-effective shipping options to meet your customers’ expectations. As soon as an order ships, tracking is pushed back to your store."}
